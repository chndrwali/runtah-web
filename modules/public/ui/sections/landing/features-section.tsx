    ...
    <section ref={containerRef} className="py-12">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-card p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-border flex flex-col items-center text-center gsap-reveal">
