        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 leading-[1.1] mb-6">
              Bandung Bersih, <br />
              <span className="text-brand">Mulai dari Genggamanmu</span>
            </h1>
            <p className="text-lg lg:text-xl text-brand-earthy mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-brand text-white text-lg font-bold rounded-theme hover:bg-brand-dark shadow-xl shadow-brand/20 transition-all transform hover:-translate-y-1">
          ...
          <div className="mt-16 lg:mt-0 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              ...
              <div className="aspect-square bg-brand-soft rounded-full absolute -top-10 -right-10 w-64 h-64 blur-3xl opacity-50"></div>
              <Image
                alt="Smartphone and Recycling Bin Illustration"
                className="relative z-10 w-full h-auto drop-shadow-2xl rounded-theme"
